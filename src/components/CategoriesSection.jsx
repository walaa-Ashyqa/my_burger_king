...
import CategoryCard from './CategoryCard'; // Reusable component for category cards
import { Container } from 'react-bootstrap';
import 'bootstrap/dist/css/bootstrap.min.css';
import './CategoriesSection.css'; // Custom CSS for the grid layout
...
function CategoriesSection() {
  const categories = [
    ...
    // Decorative orange squares (these will be styled purely with CSS grid)
  ];

  return (
    <section className="categories-section py-5">
      <Container>
        <h2 className="categories-title text-center mb-5">OUR PRODUCTS</h2> {/* Title above the grid */}
